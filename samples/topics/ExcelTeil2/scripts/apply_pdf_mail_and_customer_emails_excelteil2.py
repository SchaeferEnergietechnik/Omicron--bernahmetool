...
DEFAULT_TARGETS_REAL = [
    Path("samples/topics/ExcelTeil2/V21A_Übergeordneter_Entkupplungsschutz_Trafoschutz_NEU.xlsm"),
]

DEFAULT_TARGETS_FALLBACK = [
    Path("samples/topics/ExcelTeil2/V21_Übergeordneter_Entkupplungsschutz_Trafoschutz.xlsm"),
    Path("samples/topics/ExcelTeil2/V20b_Übergeordneter_Entkupplungsschutz_Trafoschutz.xlsm"),
    Path("samples/topics/ExcelTeil2/V21A_Übergeordneter_Entkupplungsschutz_Trafoschutz_NEU.xlsm"),
]
...
def resolve_source_path(source_path: Path) -> Path:
    ...
    fallback_candidates: list[Path] = [
        Path("samples/topics/ExcelTeil2/Muster_Termine 17.08.2026.xlsx"),
